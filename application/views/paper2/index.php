<?php
    ...
    $text = "<font color='red' class='thsarabunnew'><br/>ไม่มีงานวิจัยที่ต้องตรวจ<br/>งานวิจัยในการประชุม</font>";
    if(isset($public)){
        $resultData = $public;
  ...
  $dataShow = array(
        ...
        'paper_detail_name_th' => array('ชื่องานวิจัย', 'paper_detail_name_th', '60%', 'center', 'left'),
        'paper_detail_year' => array('วัน/เดือน/ปี ที่ส่ง', 'paper_detail_year', '40%', 'center', 'center'),
                                                ...
                                                <?php switch ($key) {
                                                  case 'option': ?>
                                                    <td style="width:100px;text-align:center;">
                                                        <button name="edit" class="btn glyphicon glyphicon-zoom-in" onclick="location.href='<?php echo base_url(); ?>paper2/show_detail/<?php echo $rowID; ?>';"><i class="fa fa-edit"></i></button>
                                                    </td>
                                                    <?php break;
                                                  default: ?>
