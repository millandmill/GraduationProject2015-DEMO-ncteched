...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url().'public/lib/';?>css/custom-validate.css">
    <link rel="stylesheet" href="<?php echo base_url().'public/lib/';?>css/custom-modal.css">
	...
	<script src="<?php echo base_url().'public/lib/';?>bootstrap3.3.4/js/bootstrap-datepicker.js"></script>
        ...
        <link href="<?php echo base_url().'public/lib/css/validator/';?>theme-default.min.css" rel="stylesheet" type="text/css" />
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top header">
      <div class="container-fluid">
        <div class="navbar-header">
          <a  class="navbar-brand"href="<?php echo base_url(); ?>#">:: NCTECHED SYSTEM</a>       
        </div>
      </div>
    </nav>
  </div><!-- end row-->