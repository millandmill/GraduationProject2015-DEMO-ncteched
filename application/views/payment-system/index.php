                  ...
                  <div class="panel-heading">
                      <div class="pull-left">
                          <div class="thsarabunnew" style="font-size:1.2em;margin-top:6px;">
                              <i class="glyphicon glyphicon-btc"></i>&nbsp;หน้าส่งสลิปการชำระเงิน<span name="total">&nbsp;-&nbsp;<?php if(isset($countData)){ echo $countData; }else{ echo "0"; }?>&nbsp;รายการ<br/>รอการชำระเงินหรือรอการตรวจสอบ</span>
                          </div>
                      </div>
                                                ...
                                                <?php switch ($key) {
                                                  case 'option': ?>
                                                    <td style="width:100px;text-align:center;">
                                                        <button name="edit" class="btn glyphicon glyphicon-zoom-in" onclick="location.href='<?php echo base_url(); ?>payment_system/show_detail/<?php echo $rowID; ?>';"><i class="fa fa-edit"></i></button>
                                                    </td>
                                                    <?php break;
                                                  default: ?>
