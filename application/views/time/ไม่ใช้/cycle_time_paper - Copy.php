                  ...
                  <div class="panel-heading">
                      <div class="pull-left">
                          <div class="thsarabunnew" style="font-size:1.2em;margin-top:6px;">
                              <i class="glyphicon glyphicon-hourglass"></i>&nbsp;จัดการ<br/>กำหนดการส่งบทความวิจัยหน้าเว็บ <span name="total">&nbsp;-&nbsp;<?php if(isset($countData)){ echo ceil($countData/4); }else{ echo "0"; }?>&nbsp;ครั้งงานประชุม</span>
                          </div>
                      </div>
                                              ...
                                              <td style="width:100px;text-align:center;" >
                                                        ...
                                                        <?php echo $rowID; ?>
                                                            <input  data-validation='required' 
                                                                    ...
                                                                    maxlength="10"
                                                                    type='text' class='font12 thsarabunnew' onblur="validate(this)" onclick="getval(this)" onkeypress="return isNumber(event)" <?php if($day_start==6){$day_start=2;} if($day_start==2){ echo "disabled";  } ?>  <?php echo "id='date_start".$rowID."'"; echo 'name="time_cycle_paper_date_start'.$rowID.'"'; ?>  <?php if($day_start!=2) echo 'value="'; if(isset($rows[$dataShow[$key][1]])){ echo $rows[$dataShow[$key][1]]; } ?>"/>
                                                  ...
                                                  case 'time_cycle_paper_date_end': ?>
                                                    ...
                                                    <td style="width:100px;text-align:center;">
                                                        ...
                                                        <input  data-validation="required" 
                                                                ...
                                                                maxlength="10"
                                                                type="text" class="font12 thsarabunnew" onblur="validate(this)" onclick="getval(this)" onkeypress="return isNumber(event)" <?php if($day_end==5){$day_end=1;} if($day_end==1){ echo "disabled style='color: transparent;'";  } ?>   <?php echo "id='date_end".$rowID."'"; echo 'name="time_cycle_paper_date_end'.$rowID.'"'; ?>  <?php if($day_end!=1) echo 'value="'; if(isset($rows[$dataShow[$key][1]])){ echo $rows[$dataShow[$key][1]]; } ?>"/>
                                                        <?php $day_end++;?>
                                                    </td>
