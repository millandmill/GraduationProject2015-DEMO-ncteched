...
?>
        <div class="col-xs-12 col-lg-9 col-sm-7 col-md-7 ">
          <div class="content">
              ...
              ?>
              <font color='red' class='thsarabunnew'><a href="../print_report/program_date_before"  target="_blank"><br/>ดูกำหนดการประชุมวิชาการครั้งที่แล้ว (ครั้งที่ <?php echo $conferences_on-1 ?>)<br/></a></font>
          </div><!-- end content -->
        </div><!-- end col-xs-12 -->
      </div>
  </div>
