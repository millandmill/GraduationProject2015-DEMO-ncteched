                        ...
                        <div class="panel-heading">
                            ...
                            <div class="pull-right">
                                <!-- START CONTROL BUTTON -->
                                    ...
                                    <button name="add" type="button" class="btn btn-success" onclick="location.href='<?php echo base_url(); ?>reviewer/reviewer_detail_add';">
                                        <i class="glyphicon glyphicon-plus"></i>&nbsp;
                                        <span class="thsarabunnew">เพิ่มข้อมูลส่วนตัว</span>
                                    </button>
                                    <?php } ?>
                                    <?php if(isset($resultData)){ ?>
                                        <button name="add" type="button" class="btn btn-info" onclick="location.href='<?php echo base_url(); ?>reviewer/reviewer_detail_add?c_id=<?php echo $resultData[0]['commeettee_id']; ?>';">
                                            <i class="glyphicon glyphicon-plus"></i>&nbsp;
