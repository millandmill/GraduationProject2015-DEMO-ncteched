...
$dataShow = array(
    ...
    'paper_detail_year' => array('วัน/เดือน/ปี ที่ส่ง', 'paper_detail_year', '20%', 'center; min-width:150px', 'center'),
);
    ...
    <div class="content">
        <div class="panel panel-warning">
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-md-12">
                        <?php echo form_open_multipart('paper_with_admin/multi_app_update_done'); ?>
...
//                                                                echo $key;
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <td colspan="3" class="thsarabunnew">
                                        <?php
                                            if(isset($selected_status)){
                                                if ($selected_status == 1){
                                                    echo "ไม่ผ่าน";
                                                }elseif ($selected_status == 2){
                                                    echo "ผ่านแต่มีการแก้ไข";
                                                }
                                                elseif ($selected_status == 3){
                                                    echo "ผ่านโดยไม่ต้องแก้ไข";
                                                }
                                ...
                                <tr>
                                    ...
                                    <td colspan="3" class="thsarabunnew">
                                        <textarea name="paper_file_format_status"></textarea><br/>
