            ...
            <div class="panel-heading">
                <div class="pull-left">
                    <div class="thsarabunnew" style="font-size:1.2em;margin-top:6px;">
                        <i class="glyphicon glyphicon-user"></i>&nbsp;งานวิจัยที่ตรวจสอบแล้ว<br/>งานวิจัยในระบบ<span name="total">&nbsp;-&nbsp;<?php if(isset($countData)){ echo $countData; }else{ echo "0"; }?>&nbsp;รายการ</span>
                    </div>
                </div>
                                    ...
                                    <tr class="thsarabunnew">
                                        ...
                                        <?php foreach($dataShow as $key => $value) { ?>
                                            <?php switch ($key) {
                                                ...
                                                case 'option': ?>
                                                    <td style="width:100px;text-align:center;">
                                                        <a onclick="location.href='<?php echo base_url(); ?>paper_with_admin/paper_checked_detail/<?php echo $rowID; ?>';"><span class="glyphicon glyphicon-zoom-in"/></a>
                                                    </td>
                                                    <?php break;
                                                default: ?>
