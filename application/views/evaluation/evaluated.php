                ...
                <div class="col-md-12">                  
                        ...
                        <div class="form-addproduct">
                            <ul>
                                ...
                                <?php } ?>
                                <li>
                                    <input type="submit" value="ตกลง" class="bt-reset thsarabunnew" name="btn_submit" onclick="window.location.href='<?php echo base_url(); ?>paper2/show_detail/<?php echo $paper_detail_id; ?>'"/> 
                                </li>
                            </ul>
                        </div>
