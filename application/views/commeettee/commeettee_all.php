...
<?php
    ...
    $text = "<font color='red' class='thsarabunnew'><br/>ไม่มีรายชื่อคณะกรรมการอยู่ในระบบ<br/>กรุณาเพิ่มรายชื่อคณะกรรมการ</font>";
    if(isset($commeettee)){
                  ...
                  <div class="panel-heading">
                      <div class="pull-left">
                          <div class="thsarabunnew" style="font-size:1.2em;margin-top:6px;">
                              <i class="glyphicon glyphicon-user"></i>&nbsp;รายชื่อคณะกรรมการ<span name="total">&nbsp;-&nbsp;<?php if(isset($countData)){ echo $countData; }else{ echo "0"; }?>&nbsp;รายการ</span>
                          </div>
                      </div>
                      <div class="pull-right">
                          <!-- START CONTROL BUTTON -->
                              <button name="add" type="button" class="btn btn-success btn-addp thsarabunnew" onclick="location.href='<?php echo base_url(); ?>commeettee/commeettee_add';">
                                  <i class="glyphicon glyphicon-plus"></i>&nbsp;
                                  <span>เพิ่มคณะกรรมการ</span>
                              </button>
                          <!-- END CONTROL BUTTON -->
                      </div>
                                                ...
                                                <?php switch ($key) {
                                                  case 'option': ?>
                                                    <td style="width:100px;">
                                                        <button name="edit" class="btn glyphicon glyphicon-wrench" onclick="location.href='<?php echo base_url(); ?>commeettee/commeettee_add?c_id=<?php echo $rowID; ?>';"><i class="fa fa-edit"></i></button> 
                                                        <br/><br/><button name="edit" type="button" class="btn btn-danger thsarabunnew" onclick="location.href='<?php echo base_url(); ?>commeettee/forget_password_commeettee?c_id=<?php echo $rowID; ?>';"><b>กดเพื่อรีเซ็ตรหัสผ่านแบบสุ่ม6หลัก</b></button>
                                                        <br/><br/><button name="edit" type="button" class="btn btn-danger thsarabunnew" onclick="location.href='<?php echo base_url(); ?>commeettee/forget_password_commeettee_123456?c_id=<?php echo $rowID; ?>';"><b>กดเพื่อรีเซ็ตรหัสผ่าน 123456</b></button>
                                                    </td>
                                                    <?php break;
                                                  default: ?>
