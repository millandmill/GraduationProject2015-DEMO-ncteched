			                        ...
			                        <form method="POST" name="form_authen" action="commeettee_detail_add" enctype="multipart/form-data">
			                                ...
			                                <ul>
								                ...
								                <li><input data-validation="required number length" 
                                                                                           ...
                                                                                           class="form-control thsarabunnew" type="text" name="zip" onkeypress="return isNumber(event)" maxlength="5" value="<?php if(isset($resultData[0]['commeettee_zip'])){ echo $resultData[0]['commeettee_zip']; } ?>"/></li><br/>
								                ...
								                <li><input  data-validation="required
                                                                                            ...
                                                                                            class="form-control thsarabunnew" type="text" name="tel" onkeypress="return isNumber(event)" maxlength="10" value="<?php if(isset($resultData[0]['commeettee_tel'])){ echo $resultData[0]['commeettee_tel']; } ?>"/></li><br/>
								                ...
								                <li><input type="submit" value="บันทึก" class="bt-submit thsarabunnew" name="btn_submit"/>
								                    <input type="reset" value="ยกเลิก" class="bt-reset thsarabunnew" name="btn_back" onclick="window.location.href='../commeettee/commeettee_detail'"/> 
								                </li>
								            </ul>
			                            </div>
			                        </form>   
